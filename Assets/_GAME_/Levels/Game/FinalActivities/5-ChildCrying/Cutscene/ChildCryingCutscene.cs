...
public class ChildCryingCutscene : MonoBehaviour
{
    ...
    private IEnumerator PlayCutscene()
    {
        ...
        daughterAnimator.SetBool("isCrying", true);
        yield return new WaitForSeconds(1f);
        LookLeft(spouseAnimator);
        StartMoving(spouseAnimator);
        yield return StartCoroutine(MoveTransformToTarget(spouseTransform, new Vector3(-3.38f, -5.62f)));
