...
public class NewOutsideHomeCutscene : MonoBehaviour
{
    ...
    private IEnumerator PlayCutscene()
    {
        ...
        yield return StartCoroutine(MoveTransformToTarget(adultTransform, new Vector3(5.56f, adultTransform.position.y)));
